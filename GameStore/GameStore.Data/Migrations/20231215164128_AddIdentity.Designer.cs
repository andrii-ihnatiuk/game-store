...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20231215164128_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Data.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("GameStore.Data.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GameStore.Data.Entities.Identity.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("GameStore.Data.Entities.Identity.AppUserRole", b =>
                {
                    b.HasOne("GameStore.Data.Entities.Identity.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameStore.Data.Entities.Identity.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("GameStore.Data.Entities.Identity.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GameStore.Data.Entities.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
